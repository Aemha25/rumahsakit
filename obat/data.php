        ...
        <div>
            <form class="form-inline" action="" method="post">
                <div class="form-group">
                    <input type="text" name="pencarian" class="form-control" placeholder="mau ngobat apa bro?">
                </div>
                <div class="form-group">
                    ...
                    while($data = mysqli_fetch_array($sql_obat)) { ?>
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="del.php?id=<?=$data['id_obat']?>" onclick="return confirm('Serius nih mau dihapus datanya?')" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></a>
                            </td>
                        </tr>
                    <?php
                    }
