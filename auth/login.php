...
<head>
    ...
    <link rel="icon" herf="<?=base_url('_assets/logo.png')?>">
</head>
<body>
    <div id="wrapper">
        <div class="container">
            <div align="center" style="margin-top: 210px;">
                ...
                <form action="" method="post" class="navbar-form">
                    <div class="input-group">
                        ...
                        <input type="text" name="user" class="form-control" placeholder="Username" reuqired autofocus>
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                        <input type="password" name="pass" class="form-control" placeholder="Password" reuqired>
                    </div>
                    <div class="input-group">
